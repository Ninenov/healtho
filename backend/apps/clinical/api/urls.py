...
from apps.clinical.api.views.context import PatientClinicalContextView
...
urlpatterns = [
    ...
    path(
        "patients/<uuid:patient_id>/context/",
        PatientClinicalContextView.as_view(),
        name="patient-clinical-context",
    ),
    path(
